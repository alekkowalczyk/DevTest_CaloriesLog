      ...
      return {
        ...
        link: function (scope, element, attrs, ctrl) {
          ...
          scope.updateModel = function () {
              scope.$parent.timeChanged();
          };
        },
        template: "<input type='text' class='form-control' ng-model='inputTime' ng-disabled='disabledInt' time-format show-meridian='showMeridian' ng-focus='open()' ng-change='updateModel()' />"
            ...
            + "            <timepicker ng-model='inputTime' show-meridian='showMeridian'  minute-step='15' ng-change='updateModel()'></timepicker> "
            + "           </div> " + "  </div>"
      };
});
